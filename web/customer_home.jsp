...
<div class="wrapper row1">
  <header id="header" class="hoc clear">
    <div id="logo" class="fl_left"> 
      <!-- ################################################################################################ -->
      <h1 class="logoname"><a href="index.html">Help At DoorStep<span></a></h1>
      <!-- ################################################################################################ -->
    </div>
    <nav id="mainav" class="fl_right" > 
      ...
      <ul class="clear">
        ...
        <li><a  href="order_item.jsp" >Order Item</a>
         <!--   <ul>
            <li><a class="drop" href="paybill.jsp" ><font color="black"><b>View Category</b></font></a>
             </ul> -->
        </li>
        <li><a  href="cancel_order.jsp" >Cancel Order</a>
         <!--   <ul>
            <li><a class="drop" href="paybill.jsp" ><font color="black"><b>View Category</b></font></a>
             </ul> -->
        </li>
        <li><a href="paybill.jsp" >Bill Payment</a>
         <!--   <ul>
            <li><a class="drop" href="paybill.jsp" ><font color="black"><b>View Category</b></font></a>
             </ul> -->
        </li>
        <li><a href="search_agent.jsp" >Search Agent</a>
         <!--   <ul>
            <li><a class="drop" href="paybill.jsp" ><font color="black"><b>View Category</b></font></a>
             </ul> -->
        </li>
        
         <li><a href="recharge_amount.jsp" >wallet</a>
         <!--   <ul>
            <li><a class="drop" href="paybill.jsp" ><font color="black"><b>View Category</b></font></a>
             </ul> -->
        </li>
        ...
        <!--
         <li><a class="drop" href="#" >Manage Agent</a>
            <ul>
            <li><a class="drop" href="view_agent.jsp" ><font color="black"><b>View Agent</b></font></a>
            </ul>
        </li>-->
       <!-- <li><a class="drop" href="#" >Manage Items</a>
            <ul>
            <li><a href="#"><font color="black"><b>Grocery</b></font></a></li>
            <li><a href="#"><font color="black"><b>Electronics Repair</b></font></a></li>
            <li><a href="#"><font color="black"><b>Home Cleaning</b></font></a></li>
            <li><a href="#"><font color="black"><b>Bill Payments</b></font></a></li>
              </ul>
        </li>  -->
...
<!--<div class="wrapper gradient">
  <div class="hoc container clear"> 
    ...
    <div class="sectiontitle">
      ...
      <h6 class="heading font-x2">Developer's Info</h6>
    </div>
...
<!-- ################################################################################################ -->
<!-- ################################################################################################ -->
<div class="wrapper row2" style="padding-left:130px;">
    ...
    <!--<article class="one_half">
      ...
      <!--<form action="#" method="post">
        <fieldset>
          ...
          <input type="text" value="" placeholder="Review">
...
<!--<div class="bgded overlay row4" style="background-image:url('images/demo/backgrounds/01.png');">
  <footer id="footer" class="hoc clear"> 
    ...
    <div class="one_quarter first">
      <h1 class="logoname"><a href="index.html">HelpAtDoorStep</a></h1>
