...
public class edit_category1 extends HttpServlet {
    ...
    out.println(id_var);
      String input = request.getParameter("pcat");
       String sql="update category set product_category='"+input+"' where product_id="+id_var+"";
        Statement st=con.createStatement();
        int i=st.executeUpdate(sql);
        if(i>0)
        {
            out.println("<h1>Edited</h1>" );
        }
        else
        {
          out.println("<h1>Couldn't edit</h1>" );   
        }
